...
import com.a360play.a360nautica.view.threadhelp.ThreadPoolManager;
...
public class FunctionActivity extends AppCompatActivity {
    ...
    private final DemoDetails[] demos = {
            new DemoDetails(R.string.function_all, R.drawable.app_icon,
                    AllActivity.class),
          /*  new DemoDetails(R.string.function_qrcode, R.mipmap.ic_launcher,
                    QrActivity.class),
            new DemoDetails(R.string.function_barcode, R.mipmap.ic_launcher,
                    BarCodeActivity.class),
            new DemoDetails(R.string.function_text, R.mipmap.ic_launcher,
                    TextActivity.class),
            new DemoDetails(R.string.function_tab, R.mipmap.ic_launcher,
                    TableActivity.class),
            new DemoDetails(R.string.function_pic, R.mipmap.ic_launcher,
                    BitmapActivity.class),
            new DemoDetails(R.string.function_multi, R.mipmap.ic_launcher,
                    null),
            new DemoDetails(R.string.function_threeline, R.mipmap.ic_launcher,
                    null),
            new DemoDetails(R.string.function_buffer, R.mipmap.ic_launcher,
                    BufferActivity.class),
            new DemoDetails(R.string.function_cash, R.mipmap.ic_launcher,
                    null),
            new DemoDetails(R.string.function_lcd, R.mipmap.ic_launcher,
                    LcdActivity.class),
            new DemoDetails(R.string.function_status, R.mipmap.ic_launcher,
                    null),
            new DemoDetails(R.string.function_blackline, R.mipmap.ic_launcher,
                    BlackLabelActivity.class),
            new DemoDetails(R.string.function_label, R.mipmap.ic_launcher,
                    LabelActivity.class)*/
    };
