...
public class AllActivity extends BasePrintActivity implements View.OnClickListener {
...
//        setBack();
    ...
    public void onPrint(View view) {
        ...
        Bitmap head = BitmapFactory.decodeResource(getResources(), R.drawable.app_icon);
