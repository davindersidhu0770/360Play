...
class AccessoryAdapter(
    ...
    val context: Context,
    val clickListener: OnAccessoryClickListener
    ...
    class ViewHolder(private val binding: TitleLayoutBinding) :
        ...
        fun bind(
            ...
            context: Context,
            clickListener: OnAccessoryClickListener
        ) {
            binding.tvaccessory.text = gameAccessory.accessory

            val childAdapter = ChildAdapter(gameAccessory.listGameAccessory,context, clickListener,adapterPosition)
